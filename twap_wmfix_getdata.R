...
eurusd.data<-read.csv(paste("~/R/R Projects/data/",year,"/DAT_ASCII_EURUSD_M1_",year,".csv",sep="")) 
usdjpy.data<-read.table(paste("~/R/R Projects/data/",year,"/DAT_ASCII_USDJPY_M1_",year,".csv",sep=""), sep=";", quote="\"")
gbpusd.data<-read.table(paste("~/R/R Projects/data/",year,"/DAT_ASCII_GBPUSD_M1_",year,".csv",sep=""), sep=";", quote="\"")
usdchf.data<-read.table(paste("~/R/R Projects/data/",year,"/DAT_ASCII_USDCHF_M1_",year,".csv",sep=""), sep=";", quote="\"")
usdnok.data<-read.table(paste("~/R/R Projects/data/",year,"/DAT_ASCII_USDNOK_M1_",year,".csv",sep=""), sep=";", quote="\"")
usdsek.data<-read.table(paste("~/R/R Projects/data/",year,"/DAT_ASCII_USDSEK_M1_",year,".csv",sep=""), sep=";", quote="\"")
audusd.data<-read.table(paste("~/R/R Projects/data/",year,"/DAT_ASCII_AUDUSD_M1_",year,".csv",sep=""), sep=";", quote="\"")
nzdusd.data<-read.table(paste("~/R/R Projects/data/",year,"/DAT_ASCII_NZDUSD_M1_",year,".csv",sep=""), sep=";", quote="\"")
usdcad.data<-read.table(paste("~/R/R Projects/data/",year,"/DAT_ASCII_USDCAD_M1_",year,".csv",sep=""), sep=";", quote="\"")
usdmxn.data<-read.table(paste("~/R/R Projects/data/",year,"/DAT_ASCII_USDMXN_M1_",year,".csv",sep=""), sep=";", quote="\"")
usdtry.data<-read.table(paste("~/R/R Projects/data/",year,"/DAT_ASCII_USDTRY_M1_",year,".csv",sep=""), sep=";", quote="\"")
usdzar.data<-read.table(paste("~/R/R Projects/data/",year,"/DAT_ASCII_USDZAR_M1_",year,".csv",sep=""), sep=";", quote="\"")
